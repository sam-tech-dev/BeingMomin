...
object ApiEndPoint {
    ...
    const val ENDPOINT_LOCALITY_AMBASSADORS = BuildConfig.BASE_URL + BuildConfig.API_EXT + "localityId-ambassadors"
    ...
    const val ENDPOINT_ADD_NEWS = BuildConfig.BASE_URL + BuildConfig.API_EXT + "add-news"
